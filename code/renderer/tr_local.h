...
#pragma pack(push,16)
	...
	byte		dlightClipBits[SHADER_MAX_VERTEXES] QALIGN(16);
	glIndex_t	dlightIndexes[SHADER_MAX_INDEXES] QALIGN(16);
	vec4_t		dlightColors[SHADER_MAX_VERTEXES] QALIGN(16);
#endif
