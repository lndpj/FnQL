...
int main( int argc, const char* argv[] )
{
	...
	std::string cmdline = Sys_BuildCommandLine( argc, argv );
	char *cmdlineData = cmdline.data();

	useXYpos = Com_EarlyParseCmdLine( cmdlineData, con_title, sizeof( con_title ), &xpos, &ypos );
