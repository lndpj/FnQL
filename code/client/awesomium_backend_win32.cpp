...
#undef FNQL_AWE_IMPORT
	...
	bool CreateRuntime( const StartupParameters &parameters ) noexcept {
		...
		// Keep the retail DataPak source authoritative for asset://ql/. Awesomium
		// treats that host specially: replacing it with a generic DataSource leaves
		// navigation at about:blank without ever dispatching OnRequest.
